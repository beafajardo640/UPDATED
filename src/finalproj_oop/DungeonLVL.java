...
public class DungeonLVL extends javax.swing.JFrame {
     ...
     private static int unlockedLevel = 1; // default unlocked level
    ...
    public DungeonLVL() {
       ...
       this.setSize(1033,678);
        ...
        levelButtons = new JButton[]{
            ...
            lvlSix, lvlSeven, lvlEighth, lvlNine, lvlTEN
        };
    ...
    // --- Update color for unlocked levels ---
    private void updateLevelButtons() {
        for (int i = 0; i < levelButtons.length; i++) {
            JButton btn = levelButtons[i];
            if (i + 1 <= unlockedLevel) {
                btn.setForeground(new Color(255, 215, 0)); // gold for unlocked
                btn.setFont(new Font("Snap ITC", Font.BOLD, 18));
            } else {
                btn.setForeground(Color.GRAY); // gray for locked
    ...
    private void initComponents() {
        ...
        getContentPane().add(dunTITLE, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 30, 420, 70));
        ...
        getContentPane().add(LVLtitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 90, -1, 30));
    ...
    new QuestionPage(this, 5).setVisible(true);
    }
