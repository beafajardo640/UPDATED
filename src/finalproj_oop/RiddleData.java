...
public class RiddleData {
    ...
    public static String[][] normalChoices = {
        ...
        {"A. Wind", "B. Shadow", "C. Echo", "D. Song"},
        {"A. Box", "B. Glass", "C. Egg", "D. Shell"},
        {"A. Candle", "B. Matchstick", "C. Tree", "D. Torch"},
    ...
    // Correct answers now mix A–D
    public static String[] normalAnswers = {"A","C","C","A","D","A","B","A","D","C"};

    // ---------- HARD ROUTE (Shortcut Path) ----------
    public static String[] hardRiddles = {
        "I have towns without people, roads without cars, and forests without wood. What am I?",
    ...
    public static String[][] hardChoices = {
        {"A. Globe", "B. Dream", "C. Map", "D. Painting"},
    ...
    public static String[] hardAnswers = {"C","B","D","A"};
}
